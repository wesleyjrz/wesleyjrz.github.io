function quote() {
  ...
  */
  ...
  if (document.documentElement.lang === 'pt-BR') {
    switch (day) {
      case 0:
        quote.innerText = '“A maioria dos bons programadores fazem programação não porque eles esperam serem pagos ou bajulados pelo público, mas sim porque é divertido programar.”';
      ...
      case 1:
        ...
        break;
      case 2:
        quote.innerText = '“Você precisa pensar de qualquer forma, então por que não pensar alto?”';
      ...
      case 4:
        ...
        break;
      case 5:
        quote.innerText = '“Nunca é alto o preço a se pagar pelo privilégio de pertencer a si mesmo.”';
      ...
      default:
        ...
        alert('Error: Não é possível carregar a citação automática, por faver, contate me no telegram @wesleyjrz');
        quote.innerText = '“Entre em contato comigo, por favor. Assim posso consertar o erro hahaha!”';
